    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (err.response?.status === 404) {
                setError(
                    'Organization not found. Check the name or create a new one.'
                )
            } else {
                setError(
                    err.response?.data?.message || 'Failed to find organization'
                )
            }
        } finally {
            setLoading(false)
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-sm text-gray-600 mt-2">
                            Enter your org name to continue to login.
                        </p>
                    </div>
                    ...
                    <div className="mt-6 text-center space-y-2">
                        ...
                        <p className="text-xs text-gray-500">
                            You can also continue without an org, but team
                            features won&apos;t work.
                        </p>
                        <button
                            type="button"
